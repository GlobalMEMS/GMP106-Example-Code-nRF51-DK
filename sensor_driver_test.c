 ...
 * Date : 2018/2/8
 *
 * Usage: GMP106 Sensor Driver Test for nRF51-DK
 *
 ****************************************************************************
 * @section License
 *
...
/*! @file sensor_driver_test.c
 *  @brief  GMP106 Sensor Driver Test Main Program 
...
int main(void)
{
  ...
  /* GMP106 I2C bus setup */
  bus_init_I2C(&gmp106_bus, &m_app_twi, GMP106_7BIT_I2C_ADDR);  //Initialize I2C bus
  gmp106_bus_init(&gmp106_bus); //Initailze GMP106 bus to I2C
  ...
  for(;;){
    ...
    fT_Celsius = GMP106_T_CODE_TO_CELSIUS(s16T);
